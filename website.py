...
def upload_new_position():
    ...
    if contents is not None:
        with st.spinner('Processing Position...'):
            new_conversation_name = utils.position_snippet_to_position_data(st.session_state.application_session ,contents)
        # Process the uploaded file if needed
        st.session_state.show_position_upload_popup = False  # Close the popup after uploading
